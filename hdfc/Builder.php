...
protected $file;
    ...
    public function OfferAvailabilityRequest(){
        ...
        $params = [];
        $params['RequestSignatureEncryptedValue'] = $this->getRequestSignatureEncryptedValue($key);
    ...
    public function getRequestSignatureEncryptedValue($randomkey){
        $payload = '{  
            "FintechRequest": {
        ...
        //$jwt_encoded = base64_encode($jwt); // not required
